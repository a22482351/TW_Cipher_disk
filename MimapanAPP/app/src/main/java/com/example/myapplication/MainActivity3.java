...
public class MainActivity3 extends AppCompatActivity {
    ...
    private Button.OnClickListener btnClickListener = v -> {
        //@Override
        //public void onClick(View view) {
            switch (v.getId()) {
                case R.id.button1:
                    //s4=button1.getText().toString();
